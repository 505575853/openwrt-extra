...
if luci.sys.call("pidof ssr-redir >/dev/null") == 0 or luci.sys.call("pidof ssr-local >/dev/null") == 0 then
	m = Map("shadowsocksr-libev", translate("ShadowSocksR-libev"), translate("ShadowSocksR-libev is running"))
else
	m = Map("shadowsocksr-libev", translate("ShadowSocksR-libev"), translate("ShadowSocksR-libev is not running"))
end
...
-- Global Setting
s = m:section(TypedSection, "shadowsocksr-libev", translate("Global Setting"))
s.anonymous = true
...
o = s:option(Flag, "tproxy", translate("Transparent Proxy"))
o.default = 1
o.rmempty = false
...
-- Obfuscation
s = m:section(TypedSection, "shadowsocksr-libev", translate("Obfuscation"))
s.anonymous = true
...
-- UDP Relay
s = m:section(TypedSection, "shadowsocksr-libev", translate("UDP Relay"))
s.anonymous = true
...
-- UDP Forward
s = m:section(TypedSection, "shadowsocksr-libev", translate("UDP Forward"))
s.anonymous = true
...
-- Access Control
s = m:section(TypedSection, "shadowsocksr-libev", translate("Access Control"))
s.anonymous = true
